  ...
  return (
    <>
      <div className={`animate-pulse`}>
        ...
        <div className="lg:flex flex-wrap grid md:flex grid-cols-3 lg:gap-4 md:gap-1 mt-[18px] min-[400px]:flex max-[767px]:flex min-[400px]:gap-1 max-[767px]:gap-1 min-[400px]:ml-4 lg:ml-0">
