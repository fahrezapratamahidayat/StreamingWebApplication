            ...
            {children && (
              <footer className="p-10 mt-[50px]">
                ...
                <div className="mt-5 flex items-center justify-center flex-col w-full">
                  <p className="text-slate-400 text-sm font-normal text-center w-[659px]">
                    Selamat datang di tempat seru kami! Nih, kita punya koleksi
                    film, acara TV, dan konten seru lainnya yang bisa kamu
                    nikmatin kapan aja. Streaming-nya jernih, ada mode
                    offline-nya juga loh! Biar makin asyik, kita juga punya
                    rekomendasi yang oke banget. Makasih udah pilih kita buat
                    jadi temen hiburanmu. Selamat menikmati, dan semoga kita
                    bisa bikin waktu luangmu makin kece.
                  </p>
                ...
                <div className="mx-32 border-t border-white opacity-30 mt-32 -z-20"></div>
                <div className="w-full flex justify-between items-center px-32 mt-10 pb-10">
